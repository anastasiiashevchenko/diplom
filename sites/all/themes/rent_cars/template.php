...
function rent_cars_commerce_cart_empty_block() {
  return '';
}
 ...
 */
function rent_cars_breadcrumb($variables){
 ...
 */
function rent_cars_preprocess_block(&$variables) {
 ...
 */
function rent_cars_preprocess_html(&$variables) {
 ...
 * Override or insert variables into the html template.
 */
function rent_cars_process_html(&$vars) {
 ...
 */
function rent_cars_preprocess_page(&$variables) {
...
*/
function rent_cars_preprocess_maintenance_page(&$variables) {
...
function rent_cars_page_alter($page) {
...
function rent_cars_form_alter(&$form, &$form_state, $form_id) {
